...
export default function TopBar() {
  ...
  return (
    <header className="hidden lg:flex print:!hidden items-center justify-between bg-white border-b border-gray-200 px-6 py-4 sticky top-0 z-30 w-full max-w-full overflow-x-hidden">
